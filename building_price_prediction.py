# -*- coding: utf-8 -*-
"""housepriceprediction_final.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1fT94HrHXG2wH456aDq2qU-KOMEcvyeYi
"""
...
f1=px.scatter(data, x="INT_SQFT", y="Derived_SALES_PRICE", color="AREA", size= "N_ROOM")
f1.show()
...
plt.subplot(222)
sns.histplot(data, x="MZZONE",kde=True, shrink=0.8)
...
"""* From this above histograms, we seen histogram for the all numerical features."""
...
print('mean_absolute_error :',metrics.mean_absolute_error(y_train,y_pred_train_lr))
print('mean_squared_error  :',metrics.mean_squared_error(y_train,y_pred_train_lr))
...
print('mean_absolute_error :',metrics.mean_absolute_error(y_train,y_pred_train_rf))
print('mean_squared_error  :',metrics.mean_squared_error(y_train,y_pred_train_rf))
...
print('mean_absolute_error :',metrics.mean_absolute_error(y_train,y_pred_train_xgb))
print('mean_squared_error  :',metrics.mean_squared_error(y_train,y_pred_train_xgb))
...
models = pd.DataFrame({'model_name':['LinearRegression','Random Forest Regressor','XGBoost Regressor'],'r2_score_train':[r2_lr_train, r2_rf_train, r2_xgb_train]})
models
...
***NOTE:***
* Random Forest Regressor model gives better r^2 value for the train data set.
"""
...
#Here, Random Forest Regressor give better r^2 value. So, I chose Random Forest Regressor model to calculate negotiate price range. 
"""
